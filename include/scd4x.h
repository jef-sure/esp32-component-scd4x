...
/**
* @brief Get the ambient pressure for continuous pressure compensation stored in the sensor.
*
* Can be sent during periodic measurements.
* Max command duration: 1 ms.
*
* @param dev          Device handle
...
/**
* @brief Sets the value of the ASC baseline target, i.e. the CO2 concentration
* in ppm which the ASC algorithm will assume as lower-bound background to which the
* SCD4x is exposed to regularly within one ASC period of operation.
* Use scd4x_persist_settings() to save to EEPROM.
* 
* Max command duration: 1 ms.
*
* @param dev     Device handle
* @param[in] target  CO2 concentration in ppm
* @return ESP_OK on success
*/
esp_err_t scd4x_set_automatic_self_calibration_target(scd4x_t *dev, uint16_t target);

/**
* @brief Gets the value of the ASC baseline target.
* 
* Max command duration: 1 ms.
*
* @param dev     Device handle
* @param target  CO2 concentration in ppm
* @return ESP_OK on success
*/
...
/**
* @brief Sets the duration of the initial period for ASC correction (in hours).
* By default, the initial period for ASC correction is 44 hours. Allowed values
* are integer multiples of 4 hours. A value of 0 results in an immediate correction.
* Use scd4x_persist_settings() to save to EEPROM.
* 
* Max command duration: 1 ms.
*
* @param dev     Device handle
* @param[in] initial_period  initial period value in hours
* @return ESP_OK on success
*/
esp_err_t scd4x_set_automatic_self_calibration_initial_period(scd4x_t *dev, uint16_t initial_period);

/**
* @brief Gets the duration of the initial period for ASC correction (in hours).
* 
* Max command duration: 1 ms.
*
* @param dev     Device handle
* @param[out] initial_period  initial period value in hours
* @return ESP_OK on success
*/
esp_err_t scd4x_get_automatic_self_calibration_initial_period(scd4x_t *dev, uint16_t *initial_period);

/**
* @brief Sets the standard period for ASC correction (in hours). By default,
* the standard period for ASC correction is 156 hours. Allowed values are integer
*  multiples of 4 hours.
* Note: a value of 0 results in an immediate correction.
* Use scd4x_persist_settings() to save to EEPROM.
* 
* Max command duration: 1 ms.
*
* @param dev     Device handle
* @param[in] standard_period  standard period value in hours
* @return ESP_OK on success
*/
esp_err_t scd4x_set_automatic_self_calibration_standard_period(scd4x_t *dev, uint16_t standard_period);

/**
* @brief Gets the standard period for ASC correction (in hours).
* 
* Max command duration: 1 ms.
*
* @param dev     Device handle
* @param[out] standard_period  standard period value in hours
* @return ESP_OK on success
*/
